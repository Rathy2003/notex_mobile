...
class ProfileDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future<void> updateProfileImage(String userId, File file) async {
      final uri = Uri.parse(
        "${Environment.API_BASE_URL}/user/update_profile_photo",
      );
    ...
    final TextEditingController username = TextEditingController(
      text: authController.userInfo.value!.username,
    );
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Obx(() {
                ...
                ImageProvider image =
                    profile != null
                        ...
                        : AssetImage("assets/images/no_profile.webp");
                return Stack(
                  children: [
                    CircleAvatar(
                      radius: 80,
                        ...
                        onTap: () async {
                          ...
                          if (pickedFile != null) {
                            await updateProfileImage(
                              authController.userInfo.value!.id,
                              pickedFile,
                            );
                          }
                        },
              ...
              SizedBox(height: 45),
              CustomTextField(textController: username, hintText: "Username"),
              SizedBox(height: 25),
              CustomTextField(textController: email, hintText: "Email Address"),
              SizedBox(height: 25),
              CustomButton(onPressed: () {}, label: "Save Change"),
